...
const { refreshMqttSubscriptions } = require('../services/mqtt.service');
  ...
  function buildMqttTopic(deviceCode, componentType, componentName, index) {
    return `electra/${toMqttTopicPart(deviceCode)}/${componentType}/${toMqttTopicPart(componentName)}_${index + 1}`;
  }
